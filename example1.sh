...
pushd "$baseDir" > /dev/null
  ...
  python3 coloraligns/apply_colors.py -i sampledata/conus-example-aligned.fasta -c sampledata/colordef.txt -l 32 -n 14 -o conus_sample1.tex

  pdflatex conus_sample1.tex
